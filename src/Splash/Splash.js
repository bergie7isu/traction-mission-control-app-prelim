        ...
        return (
            <div className='splash'>
                <header className='splash-header'>
                    ...
                    <p className='splash-header-description'>The Traction Mission Control App is your goto tool for driving accountability, followthrough, and consistent communication in your organization running on the EOS Platform.</p>
                    <Link to='/L10Meeting'>
                        <button className='go-to-app-button'>Let's Do This!</button>
                    </Link>
                </header>
                ...
                <footer className='splash-footer'>
                    ...
                    <Link to='/L10Meeting'>
                        <button className='go-to-app-button small'>Go for Launch!</button>
                    </Link>
                </footer>
            </div>
        );
